                ...
                <div class="flex flex-wrap items-center -m-1.5">
                    ...
                    <ModalAction id="announcement-modal" :modalOpen="announcementModalOpen" @close-modal="announcementModalOpen = false">
                      ...
                      <div class="mb-2 text-center">
                        ...
                        <div class="inline-flex mb-2">
                          <img src="https://jobhunstorage.sgp1.digitaloceanspaces.com/assets/images/web/announcement-icon.svg" width="80" height="80" alt="Announcement" />
                        </div>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBlank id="news-modal" :modalOpen="newsModalOpen" @close-modal="newsModalOpen = false">
                      <div class="relative">
                        <img class="w-full" src="https://jobhunstorage.sgp1.digitaloceanspaces.com/assets/images/web/modal-image.jpg" width="460" height="200" alt="New on Mosaic" />
                        <!-- Close button -->
