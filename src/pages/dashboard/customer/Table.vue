...
const updateData = async(payload) => {
  const res = await customerStore.updateCustomer(payload)
  if(res != null){
          ...
          <div class="overflow-x-auto">
            <table class="table-auto w-full">
              <thead class="text-md text-black bg-slate-50">
                <tr>
                  ...
                  <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <div class="font-semibold text-left"><a href="#" @click="sortData('name')">Name</a></div>
                  </th>
                  <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <div class="font-semibold text-left"><a href="#" @click="sortData('email')">Email</a></div>
                  </th>
                  <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <div class="font-semibold text-left"><a href="#" @click="sortData('phone')">Phone</a></div>
                  </th>
                  <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <div class="font-semibold text-left"><a href="#" @click="sortData('address')">Address</a></div>
                  </th>
                  <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
              ...
              <tbody class="text-sm divide-y divide-slate-200" v-if="props.data.length > 0">
                <tr v-for="(row, index) in props.data">
                  ...
                  <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <button
                      @click="editData(row)"
                      class="text-orange-500 hover:text-rose-900 rounded-full"
                    >Edit</button>
                  </td>
                </tr>
              </tbody>
              <tbody class="text-sm divide-y divide-slate-200" v-else>
                <tr>
                  <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap" colspan="6">
