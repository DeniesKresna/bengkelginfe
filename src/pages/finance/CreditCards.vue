    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto  bg-white">
      ...
      <main>
        ...
        <div class="lg:relative lg:flex">
          ...
          <!-- Sidebar -->
          <div>
            <div class="lg:sticky lg:top-16 bg-slate-50 lg: lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-slate-200 lg:w-[390px] lg:h-[calc(100vh-64px)]">
              <div class="py-8 px-4 lg:px-8">
                <div class="max-w-sm mx-auto lg:max-w-none">
                  ...
                  <!-- Credit Card -->
                  <div class="relative aspect-[7/4] bg-gradient-to-tr from-slate-600 to-slate-800 p-5 rounded-xl shadow-lg ">
