...
<template>
  <div>
    ...
    <div
      ...
      :class="
        sidebarOpen
          ? 'opacity-100 bg-gray-100 bg-opacity-30'
    ...
    >
      ...
      <div class="flex justify-between mb-10 pr-3 sm:px-2">
        ...
        <a href="/" class="mx-auto" v-else>
          <img
            src="https://jobhunstorage.sgp1.digitaloceanspaces.com/assets/images/web/Logo-J-Jobhun-04.png"
            alt="Logo Jobhun"
            class="h-10 sm:h-8 logo-j transition-all duration-200 ease-in-out"
          />
        </a>
      </div>
          ...
          <ul>
            ...
            >
              <li class="mb-1 last:mb-0 px-3 py-2">
                <router-link
                  class="block text-black hover:text-emerald-500 transition duration-150 truncate"
                  :class="isExactActive && '!text-emerald-500'"
                  :to="href"
                  @click="navigate"
                >
                  <div class="flex items-center">
...
//     navigateToKonsultasiTable();
//   }
// })

// const navigateToKonsultasiTable = ()=>{
//   router.push('/konsultasi/table');
// }
